...
(cl:defmethod cl:initialize-instance :after ((m <control_commands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'control_commands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name thorvald_2d_nav-msg:<control_commands> is deprecated: use thorvald_2d_nav-msg:control_commands instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <control_commands>))
...
(cl:defmethod drive_mode-val ((m <control_commands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader thorvald_2d_nav-msg:drive_mode-val is deprecated.  Use thorvald_2d_nav-msg:drive_mode instead.")
  (drive_mode m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <control_commands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader thorvald_2d_nav-msg:vel-val is deprecated.  Use thorvald_2d_nav-msg:vel instead.")
  (vel m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <control_commands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader thorvald_2d_nav-msg:position-val is deprecated.  Use thorvald_2d_nav-msg:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<control_commands>)))
  ...
  "thorvald_2d_nav/control_commands")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'control_commands)))
  "Returns string type for a message object of type 'control_commands"
  "thorvald_2d_nav/control_commands")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<control_commands>)))
  ...
  "ce831b56ace7f536470f4f55811bd8a4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'control_commands)))
  "Returns md5sum for a message object of type 'control_commands"
  "ce831b56ace7f536470f4f55811bd8a4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<control_commands>)))
  ...
  (cl:format cl:nil "Header header~%int16 drive_mode~%int16[] vel~%int32[] position~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'control_commands)))
  "Returns full string definition for message of type 'control_commands"
  (cl:format cl:nil "Header header~%int16 drive_mode~%int16[] vel~%int32[] position~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
