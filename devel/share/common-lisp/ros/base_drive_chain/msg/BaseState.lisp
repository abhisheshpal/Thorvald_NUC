...
(cl:defmethod cl:initialize-instance :after ((m <BaseState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BaseState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name base_drive_chain-msg:<BaseState> is deprecated: use base_drive_chain-msg:BaseState instead.")))
...
(cl:defmethod vel-val ((m <BaseState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_drive_chain-msg:vel-val is deprecated.  Use base_drive_chain-msg:vel instead.")
  (vel m))
...
(cl:defmethod pos_max_vel-val ((m <BaseState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader base_drive_chain-msg:pos_max_vel-val is deprecated.  Use base_drive_chain-msg:pos_max_vel instead.")
  (pos_max_vel m))
