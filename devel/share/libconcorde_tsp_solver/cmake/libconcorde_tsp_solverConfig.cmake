...
if("TRUE" STREQUAL "TRUE")
  set(libconcorde_tsp_solver_SOURCE_PREFIX /home/vigneshnuc/catkin_ws/src/Extra Packages/cob_extern-indigo_dev/libconcorde_tsp_solver)
  set(libconcorde_tsp_solver_DEVEL_PREFIX /home/vigneshnuc/catkin_ws/devel)
  ...
  set(libconcorde_tsp_solver_INSTALL_PREFIX /home/vigneshnuc/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'libconcorde_tsp_solver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Richard Bormann <richard.bormann@ipa.fraunhofer.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'libconcorde_tsp_solver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vigneshnuc/catkin_ws/src/Extra Packages/cob_extern-indigo_dev/libconcorde_tsp_solver/${idir}'.  Ask the maintainer 'Richard Bormann <richard.bormann@ipa.fraunhofer.de>' to fix it.")
    endif()
