...
"""autogenerated by genpy from thorvald_2d_nav/RampClimbingActionResult.msg. Do not edit."""
import sys
...
class RampClimbingActionResult(genpy.Message):
  _md5sum = "46448dbdc97a62b1633ebcac64aa12aa"
  _type = "thorvald_2d_nav/RampClimbingActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','thorvald_2d_nav/RampClimbingResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RampClimbingActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = thorvald_2d_nav.msg.RampClimbingResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = thorvald_2d_nav.msg.RampClimbingResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_q().pack(self.result.dummy))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.dummy,) = _get_struct_q().unpack(str[start:end])
      return self
